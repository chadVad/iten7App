    ...
    return (
        <group {...props} dispose={null} ref={ref}
            position={[0.0, 0, 0]}
                ...
                <mesh geometry={nodes['01_block'].geometry} material={materials.paintingDiffA} />


                    </group>
                    <group position={[2.0, 2.04, -2.28]}>
                        <group ref={secRef}>
                    <mesh geometry={nodes['02_block'].geometry} material={materials.paintingDiff} />
                    ...
                    <group position={[-3.84, 5.19, -2.28]} rotation={[0, 1.57, 0]}>
                        <group ref={fifthRef}>
                    <mesh geometry={nodes['03_block'].geometry} material={materials.matUp} />
